...
let retangulo_1 = new Retangulo('black','red',2,0,0,30,30)
let retangulo_2 = new Retangulo('black','blue', 2,200,200,30,30)
let retangulo_3 = new Retangulo('black','green', 2,200,200,30,30)

function animacao(){
    if (retangulo_1.x == 400){
        retangulo_1.x = 0
    }
    retangulo_1.x +=1;                  //mudar o objeto de lugar 
    ctx1.clearRect(0,0,400,400)       //apagar a imagem 
